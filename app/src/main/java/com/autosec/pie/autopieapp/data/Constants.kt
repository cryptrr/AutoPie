...
class AutoPieConstants {
    companion object {
        const val AUTOPIE_INIT_ARCHIVE_URL = "https://github.com/cryptrr/AutoPie/releases/download/v0.15.2-beta/autopie-init-2.2.tar.xz"
...
class AutoPieStrings {
    companion object {
        ...
        const val COMMANDS_REPOSITORY_URL = "https://github.com/cryptrr/autopie-commands"
        const val COMMANDS_JSON_README_URL = "$GITHUB_URL#commandsjson"
