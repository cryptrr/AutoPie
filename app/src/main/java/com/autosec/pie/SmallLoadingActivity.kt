...
class SmallLoadingActivity : ComponentActivity() {
    ...
    companion object {
        ...
        private val activeActivities = mutableMapOf<Int, WeakReference<SmallLoadingActivity>>()
        ...
        fun start(context: Context, processId: Int) {
            ...
            val intent = Intent(context, SmallLoadingActivity::class.java).apply {
