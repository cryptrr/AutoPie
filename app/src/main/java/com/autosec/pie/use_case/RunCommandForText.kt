...
import com.autopi.utils.containsValidHttpUrl
import com.autopi.utils.containsValidUrl
import com.autopi.utils.extractAllUrls
import com.autopi.utils.extractFirstUrl
    ...
    operator fun invoke(item: CommandModel, inputText: String, inputFiles: List<String>, commandExtraInputs: List<CommandExtraInput> = emptyList(), processId: Int) : Flow<CommandResult> {
        ...
        return flow {
            ...
            val inputParsedData = mutableListOf<InputParsedData>().also {
                ...
                it.add(InputParsedData(name = "INPUT", value = inputText))
